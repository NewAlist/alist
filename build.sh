appName="alist"
builtAt="$(date +'%F %T %z')"
gitAuthor="luolili233 <i@newalist.top>"
...
FetchWebDev() {
  curl -L https://codeload.github.com/NewAlist/web-dist/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/NewAlist/alist-web/releases/latest/download/dist.tar.gz -o dist.tar.gz
