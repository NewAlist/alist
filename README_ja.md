...
<div>
  ...
  <a title="Crowdin" target="_blank" href="https://crowdin.com/project/newalist">
...
- [x] WebDav (詳細は https://doc.newalist.top/guide/webdav.html を参照)
...
一般的なご質問は[ディスカッションフォーラム](https://github.com/NewAlist/alist/discussions)をご利用ください。**問題はバグレポートと機能リクエストのみです。**
...
- もし侵害があれば、[メール](mailto:i@newalist.top)で私に連絡してください。
